...
if    (!isset($fupload) or empty($fupload) or $fupload =='')
        ...
        $avatar    = "../img/avatars/net-avatara.jpg"; //можете    нарисовать net-avatara.jpg или взять в исходниках
        }          
else 
        {

        //иначе - загружаем изображение пользователя
        $path_to_90_directory    = '../img/avatars/';//папка,    куда будет загружаться начальная картинка и ее сжатая копия          
...
$delfull    = $path_to_90_directory.$filename; 
 ...
 // если такого нет, то сохраняем данные
    $query2 = "INSERT INTO users (login,password,avatar) VALUES('$login','$password', '$avatar')";
    ...
    echo "Произошла ошибка! Вы не зарегистрированы.";
    }
    ?>